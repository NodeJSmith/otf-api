...
async def main():
    ...
    studios = await otf.studios_api.search_studios_by_geo(40.7831, 73.9712, distance=100)
    ...
    classes = await otf.classes_api.get_classes(studio_uuids)
    ...
    print(json.dumps(class_types, indent=4, default=str))
    ...
    bookings = await otf.member_api.get_bookings()
    print(bookings[0].model_dump_json(indent=4))
