...
class OutOfStudioWorkoutHistory(OtfItemBase):
    ...
    red_zone_seconds: float | None = Field(None, validation_alias="redZoneSeconds")
    orange_zone_seconds: float | None = Field(None, validation_alias="orangeZoneSeconds")
    green_zone_seconds: float | None = Field(None, validation_alias="greenZoneSeconds")
    blue_zone_seconds: float | None = Field(None, validation_alias="blueZoneSeconds")
    grey_zone_seconds: float | None = Field(None, validation_alias="greyZoneSeconds")
